...
class Transform_pdf_file:
    ...
    def __init__(self,pdf_file,file_path,name):
    ...
    def subtract_tables_sentences_from_pdf(self):
        ...
        self.subtract_files(self.name + '.txt',self.name + '_table.txt',self.name + '_cleaned.txt') 
    ...
    def create_structured_data(self):
        ...
        textFile = self.name + '_cleaned.txt'
