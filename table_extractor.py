...
# from transformers import DetrImageProcessor,AutoImageProcessor,AutoFeatureExtractor,YolosImageProcessor
...
class TableExtraction:
    ...
    def plot_results_text_only(self):
        ...
        #apo edw pairnoume tis sintetagmenes pou kanoun export ta plaisia 
        ##i) tha xrisimopoiisoume to matplotlib wste na kanoume fill to table kai na min iparxei stin exported eikona
        ##ii) tha kopsoume tin eikona stis sintetagemenes pou iparxoun mesa sto file etsi wste na kopsoume mono to table.
